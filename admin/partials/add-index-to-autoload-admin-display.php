...
<div id="aital-admin-wrapper">
    ...
    <section id="aital-about" class="aital-card">
        <?php if ( version_compare( $wp_version, '5.3', '>=' ) ) { ?>
            <h2 class="aital-bg-red aital-white">
                <?php echo __( 'This website is running WordPress 5.3 or greater, you do not need this plugin!',
